...
Asena.addCommand({pattern: 'unit ?(.*)', fromMe: wk, desc: description, usage: 'El modo de uso es /unit 1 kg mg // /unit <número> <unidad1> <unidad2>'}, (async (message, match) => {
...
Asena.addCommand({pattern: 'bitunit ?(.*)', fromMe: wk, desc: bit, usage: 'El modo de uso es /bitunit 1 gb mb // /bitunit <número> <unidad1> <unidad2>'}, (async (message, match) => {
  var splitted_text = match[1].split(' ')
